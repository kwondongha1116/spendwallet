...
export default function WeeklyNewsCard() {
  ...
  if (error) {
    return (
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-4 text-xs text-gray-700">
  ...
  const { headlines, insight, top_category } = data

  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-4 text-xs text-gray-800">
      <div className="text-sm font-medium mb-2">📢 이번 주 이슈 브리핑</div>
