...
---
예시:
- "택시 12000원" → {"category": "교통", "motivation": "효율"}
- "커피 5000원" → {"category": "식비", "motivation": "즐거움"}
- "헬스장 60000원" → {"category": "건강", "motivation": "관리"}
- "강의 수강료 80000원" → {"category": "교육", "motivation": "자기계발"}
- "회식 30000원" → {"category": "식비", "motivation": "관계"}
- "명품 신발 400000원" → {"category": "쇼핑", "motivation": "충동"}
