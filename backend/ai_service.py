...
판단 가이드라인:
- 음식, 외식, 배달, 오마카세 등은 → category="식비"
  - 단, 고급 외식/사치성은 tags에 "보상형" 또는 "낭비형" 포함
- 교통 관련(택시, 버스, 주유, 세차 등)은 → category="교통", tag="시간절약형" 또는 "생활필수형"
- 카페, 커피, 디저트 등은 → category="식비", tag="보상형" 또는 "감성형"
- 옷, 화장품, 명품 등은 → category="쇼핑", tag="보상형" 또는 "과시형"
- 술, 회식, 모임, 친구와의 만남 등은 → category="여가", tag="사교형"
- 운동, 병원, 약, 헬스장 등은 → category="건강", tag="건강관리형"
- 책, 강의, 교육비, 개발툴 등은 → category="교육", tag="자기계발형" 또는 "투자형"
- 여행, 숙박, 항공 등은 → category="여행", tag="기분전환형" 또는 "보상형"
